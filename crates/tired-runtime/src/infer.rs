//! Schema inference for `tired inspect`: given a JSON sample (from a live endpoint or a
//! file), reconstruct TIRED `type` declarations. Object fields become typed fields,
